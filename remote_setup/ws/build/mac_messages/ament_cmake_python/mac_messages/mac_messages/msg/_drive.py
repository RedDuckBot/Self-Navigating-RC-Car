...
class Metaclass_Drive(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('mac_messages')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'mac_messages.msg.Drive')
            logger.debug(
...
class Drive(metaclass=Metaclass_Drive):
    ...
    def __init__(self, **kwargs):
        ...
        self.control_input = kwargs.get('control_input', int())
    ...
    def __eq__(self, other):
        ...
        if self.command != other.command:
            return False
        if self.control_input != other.control_input:
            return False
        return True
    ...
    def control_input(self, value):
        if __debug__:
            assert \
                ...
                "The 'control_input' field must be of type 'int'"
            assert value >= -32768 and value < 32768, \
                "The 'control_input' field must be an integer in [-32768, 32767]"
